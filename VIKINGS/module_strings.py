...
##  ("nothing", "nothing"),
  ...
  ("tutorial_map1","You are now viewing the world map. Left-click on the map to move your party to that location, enter the selected town, or pursue the selected party.\
^Time will pause on the overland map if your party is not moving, waiting or resting. To wait anywhere simply press and hold down the space bar.\
^This is a good moment to save your game! Press the Esc key and choose Save As or use F12 for quick saving.^^Good luck!"),
#chief
...
#new pretenders
  ...
  ("khergit_rebellion_pretender_intro",    "I'm Oswine, the exiled ealdorman of Northhymbre."), #Ealdorman from Norhumbria lost land for danish invasion and want to be King of the north. His Grandparent was  Aelle of Northumbria, who killed Ragnar lodbrok
  ("nord_rebellion_pretender_intro",       "I'm Ceorl. I will soon rule over West Seaxe."), #From weessex, son of Aethelstan, eldest brother of Aethelred and former King of Cent
  ...
  ("khergit_rebellion_pretender_story_2",  "All who had not openly joined them, they kicked off their ancestral lands. Just like that, the kingdom that had lasted centuries disappeared. Our forefathers would be ashamed."),
  ...
  ("khergit_rebellion_pretender_story_3",  "However, I have since united all my people under my banner again. I have gathered even more men that any of my ancestors, but I'm afraid I need more good leaders. Some of the best commanders died in futile resistance to the Danes. I can offer you to lead one of my armies, and, if we achieve our goal, you might have your own city to rule."),
  ...
  ("khergit_rebellion_monarch_response_1", "Who? I don't know that name. The Danish help me establish my claim, and there is nothing left for those who have lost their right to the land."),
  ...
  ("khergit_rebellion_monarch_response_2", "I will not tolerate any pretender to my crown. He and everyone who supports him will be arrested if they try anything unlawful. These are my people now, and I will protect them."),
...
####
  ...
  ("s18_is_soft_and_weak_and_not_fit_to_govern_a_fief_and_i_have_always_detested_him", "{s18} is soft, weak, and not fit to govern a fief. I have always detested him."),
...
# vc options
  ...
  #tutorial
  ("game_concepts_tutorial", "^^By now, you have some experience with Viking Conquest. If this is your first game, \
we recommend making yourself familiar with some of the game concepts. You will be directed to a page that \
...
from there the 'Game concepts' button."),
  ...
  ("game_difficulty_warning", "Game Difficulty Warning"),
